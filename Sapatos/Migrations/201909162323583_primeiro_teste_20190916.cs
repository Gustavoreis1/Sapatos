namespace Sapatos.Migrations
{
    ...
    public partial class primeiro_teste_20190916 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Estados_ID_Estado = c.Int(),
                    })
                .PrimaryKey(t => t.ID_Cidade)
                .ForeignKey("dbo.Estados", t => t.Estados_ID_Estado)
                .Index(t => t.Estados_ID_Estado);
                ...
                c => new
                    {
                        ...
                        Modelo_ID_Nodelo = c.Int(),
                    })
                .PrimaryKey(t => t.ID_Sapato)
                .ForeignKey("dbo.Modeloes", t => t.Modelo_ID_Nodelo)
                .Index(t => t.Modelo_ID_Nodelo);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Cidades", "Estados_ID_Estado", "dbo.Estados");
            ...
            DropIndex("dbo.Cidades", new[] { "Estados_ID_Estado" });
